...
public class RegisterPage {
		...
		public boolean registerUser(String firstName, String lastName,
			...
			WebElement firstName_ele = eleUtil.waitForElementVisible(this.firstName, FrameworkConstants.DEFAULT_ELEMENT_TIME_OUT);
			firstName_ele.clear();
			...
			String successMesg = eleUtil.waitForElementVisible(registerSuccessMesg, FrameworkConstants.DEFAULT_TIME_OUT).getText();

			if (successMesg.contains(FrameworkConstants.ACCOUNT_REGISTER_SUCCESS_MESSG)) {
		...
		public String  getrandomemail() {
			...
			String email= "sai"+random.nextInt(1000)+"@gmail.com";
			return email;
		}
